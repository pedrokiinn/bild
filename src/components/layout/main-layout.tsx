...
import { User, login, logout, signInWithGoogle, register } from '@/lib/auth';
            ...
            <Card className="w-full max-w-md shadow-2xl border-0">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-xs uppercase text-muted-foreground"><span className="bg-white px-2">Ou acesse com</span></div>
                    </div>

                    <Button variant="outline" className="w-full h-12 gap-2" onClick={handleGoogleLogin} disabled={isLoading}>
